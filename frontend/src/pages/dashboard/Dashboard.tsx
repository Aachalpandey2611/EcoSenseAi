  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-full min-h-[60vh]">
        <div className="w-8 h-8 rounded-full border-b-2 border-l-2 border-[var(--primary)] animate-spin" />
      </div>
    );
  }
  ...
  if (isError || !stats) {
    return (
      <div className="flex flex-col items-center justify-center h-full min-h-[60vh] text-red-400">
        ...
        <Link to="/dashboard/track" className="mt-4 text-[var(--primary)] hover:underline text-sm">
